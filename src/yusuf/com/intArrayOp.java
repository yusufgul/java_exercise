...
public class intArrayOp {
  ...
  static void findBiggest(int[] myIntArray) {
    ...
    for (int i = 0; i < myIntArray.length; i++) if (
      myIntArray[i] >= theBiggest
    ) theBiggest = myIntArray[i];

    System.out.println(
      "THE BIGGEST NUMBER AMONG THE NUMBERS YOU HAVE ENTERED IS: " + theBiggest
    );
  ...
  static void findSmallest(int[] myIntArray) {
    ...
    for (int i = 0; i < myIntArray.length; i++) if (
      myIntArray[i] <= theSmallest
    ) theSmallest = myIntArray[i];

    System.out.println(
      "THE SMALLEST NUMBER AMONG THE NUMBERS YOU HAVE ENTERED IS: " +
      theSmallest
    );
  ...
  static void averageNumber(int[] myIntArray) {
    ...
    System.out.println(
      "THE AVERAGE NUMBER OF GIVEN NUMBERS IS: " + (sum / myIntArray.length)
    );
  ...
  static void switchBlock(int[] myIntArray) {
    ...
    while (!end) {
      switch (menu()) {
        case 1:
          findBiggest(myIntArray);
          break;
        case 2:
          findSmallest(myIntArray);
          break;
        case 3:
          averageNumber(myIntArray);
          break;
        case 4:
          SmallToBig(myIntArray);
          break;
        case 5:
          myIntArray = getArray();
          break;
